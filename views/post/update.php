...
$this->title = 'Редактирование объявления - soldr';
$this->params['breadcrumbs'][] = ['label' => 'Posts', 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => $modelPost->name, 'url' => ['view', 'id' => $modelPost->id]];
...
<div class="breadcrumbs">
    <div class="breadcrumbs-container">
        <ul class="breadcrumbs-list">
            ...
            <li class="breadcrumbs-list-item">
                <a href="/post/update?id=<?= $modelPost->id?>"><span>Редактировать</span></a>
            </li>
        </ul>
    </div>
</div>
    ...
    <div class="content-main">
        ...
        <div class="post-create">
            ...
            <div class="post-form">
                ...
                $properties = Category::findOne([$modelPost->category_id])->getPropertiesForCreate();
                ?>
                <?php
                ...
                <?= $form->field($modelPost, 'price')->textInput() ?>
