...
\app\assets\UserPostAsset::register($this);

/* @var $this yii\web\View */
/* @var $models \app\models\Post[] */
/* @var $pages \yii\data\Pagination */
/* @var $totalCount int */
$this->title = 'Мои объявления - soldr';
?>
<div class="breadcrumbs">
    <div class="breadcrumbs-container">
        <ul class="breadcrumbs-list">
            ...
            <li class="breadcrumbs-list-item">
                <a href="/user/post-active"><span>Мои объявления</span></a>
            </li>
            <li class="breadcrumbs-list-item">
                <a href="/user/post-old"><span>Завершенные</span></a>
            </li>
        </ul>
    </div>
</div>
<div class="content">
    ...
    <div class="content-main">
        ...
        <div class="post-nav-tabs">
            <a href="post-active" class="post-nav">
                <span>Активные</span>
        ...
        <?php if (count($models)==0): ?>
            <div class="post-empty">
                ...
                <a href="/post/create" class="post-create-button">Подать объявление</a>
            </div>
        <?php endif; ?>
    </div>
</div>
