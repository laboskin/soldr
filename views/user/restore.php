...
\app\assets\UserRestoreAsset::register($this);

$this->title = 'Восстановление пароля';
/* @var $this yii\web\View */
/* @var $model app\models\UserRestoreForm */
/* @var $form ActiveForm */
...
<div class="breadcrumbs">
    <div class="breadcrumbs-container">
        <ul class="breadcrumbs-list">
            ...
            <li class="breadcrumbs-list-item">
                <a href="/user/restore"><span>Восстановление пароля</span></a>
            </li>
        </ul>
    </div>
</div>
    ...
    <div class="content-main">
        ...
        <div class="user-restore">
            ...
            <div class="form-group">
                <?= Html::submitButton('Восстановить', ['class' => 'applyButton']) ?>
            </div>
            <?php ActiveForm::end(); ?>
